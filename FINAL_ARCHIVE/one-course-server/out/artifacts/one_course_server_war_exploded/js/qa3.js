...
function onClickNewPostPost() {
    ...
    var method = "post";
    var url = getPagePrefix() + "/course-post.jsp";
...
function postNewDiscussion() {
    ...
    var xhr = new XMLHttpRequest();
    var method = "post";
    var url = getPagePrefix() + "/course-post-discussion.jsp";
...
function getAllPost(element) {
                ...
                if (jsonResponse.code === 201) {
                    ...
                    xmlhttp2.onreadystatechange = function() {
                        if (xmlhttp2.readyState === 4) {
                            if (xmlhttp2.status >= 200 && xmlhttp2.status < 300 || xmlhttp2.status === 304) {
                                var jsonResponse = JSON.parse(xmlhttp2.responseText);
                                if (jsonResponse.code === 201) {
    ...
    var loginParam = "email=123&pass=123";
    var loginUrl = getPagePrefix() + "/login.jsp";
    xmlhttp.open("post", loginUrl, true);
    xmlhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    xmlhttp.send(loginParam);
}
